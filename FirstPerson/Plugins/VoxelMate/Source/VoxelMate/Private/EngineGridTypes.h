...
{
    WriteValue<FFloatRangeBound>(os, InValue.GetLowerBound());
    WriteValue<FFloatRangeBound>(os, InValue.GetUpperBound());
}
...
{
    WriteValue<FInt32RangeBound>(os, InValue.GetLowerBound());
    WriteValue<FInt32RangeBound>(os, InValue.GetUpperBound());
}
...
VOXELMATEINLINE void WriteValue<FInterpCurvePointFloat>(OutputStreamType& os, const FInterpCurvePointFloat& InValue)
{
    ...
    WriteValue<uint8>(os, (uint8)InValue.InterpMode.GetValue());
}
