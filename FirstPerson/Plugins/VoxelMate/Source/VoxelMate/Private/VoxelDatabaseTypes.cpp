...
VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataAffineCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataAffineCoordinateTransform& InLhs, const FMetadataAffineCoordinateTransform& InRhs)
{
	return InLhs.Value.Matrix.Equals(InRhs.Value.Matrix);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataUnitaryCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataUnitaryCoordinateTransform& InLhs, const FMetadataUnitaryCoordinateTransform& InRhs)
{
	return InLhs.Value.Quat.Equals(InRhs.Value.Quat);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataScaleCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataScaleCoordinateTransform& InLhs, const FMetadataScaleCoordinateTransform& InRhs)
{
	return InLhs.Value.ScaleVec.Equals(InRhs.Value.ScaleVec);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataUniformScaleCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataUniformScaleCoordinateTransform& InLhs, const FMetadataUniformScaleCoordinateTransform& InRhs)
{
	return FMath::IsNearlyEqual(InLhs.Value.ScaleValue, InRhs.Value.ScaleValue);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataTranslationCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataTranslationCoordinateTransform& InLhs, const FMetadataTranslationCoordinateTransform& InRhs)
{
	return InLhs.Value.TranslationVec.Equals(InRhs.Value.TranslationVec);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataScaleTranslationCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataScaleTranslationCoordinateTransform& InLhs, const FMetadataScaleTranslationCoordinateTransform& InRhs)
{
	return InLhs.Value.ScaleVec.Equals(InRhs.Value.ScaleVec) &&
		   InLhs.Value.TranslationVec.Equals(InRhs.Value.TranslationVec);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataUniformScaleTranslationCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataUniformScaleTranslationCoordinateTransform& InLhs, const FMetadataUniformScaleTranslationCoordinateTransform& InRhs)
{
	return FMath::IsNearlyEqual(InLhs.Value.ScaleValue, InRhs.Value.ScaleValue) &&
		   InLhs.Value.TranslationVec.Equals(InRhs.Value.TranslationVec);
}

VOXELMATEINLINE std::ostream& operator<<(std::ostream& os, const FMetadataNonlinearFrustumCoordinateTransform& InValue)
{
	//TODO
	return os;
}

VOXELMATEINLINE bool operator==(const FMetadataNonlinearFrustumCoordinateTransform& InLhs, const FMetadataNonlinearFrustumCoordinateTransform& InRhs)
{
	return FMath::IsNearlyEqual(InLhs.Value.Depth, InRhs.Value.Depth) &&
		   FMath::IsNearlyEqual(InLhs.Value.Taper, InRhs.Value.Taper) &&
		   InLhs.Value.Box.Min.Equals(InRhs.Value.Box.Min) &&
		   InLhs.Value.Box.Max.Equals(InRhs.Value.Box.Max);
}
