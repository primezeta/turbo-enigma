...
{
    template<typename Type> VOXELMATEINLINE CONSTEXPR int32 SizeOf();

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::Vec3d>()
    {
        //Size of the primitive type (double) * 3
        return sizeof(openvdb::Vec3d::ValueType)*openvdb::Vec3d::size;
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::Mat4d>()
    {
    ...
    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::Coord>()
    {
    ...
    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::CoordBBox>()
    {
        //Size of the min and max components (each are openvdb::Coord)
        return 2 * SizeOf<openvdb::Coord>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::ScaleMap>()
    {
    ...
    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::TranslationMap>()
    {
        //Size of the translation (is an openvdb::Vec3d)
        return SizeOf<openvdb::Vec3d>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::ScaleTranslateMap>()
    {
    ...
    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::UniformScaleMap>()
    {
        //Size of the scale, voxel scale, inverse scale, inverse scale squared, and the inverse 2x-scale (each are openvdb::Vec3d)
        return 5 * SizeOf<openvdb::Vec3d>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::UniformScaleTranslateMap>()
    {
        //Size of the translation, scale, voxel scale, inverse scale, inverse scale squared, and inverse 2x-scale (each are openvdb::Vec3d)
        return 6 * SizeOf<openvdb::Vec3d>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::AffineMap>()
    {
        //Size of the 4d-matrix (is an openvdb::Mat4d)
        return SizeOf<openvdb::math::Mat4d>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::UnitaryMap>()
    {
        //Size of the affine map (is an openvdb::math::AffineMap)
        return SizeOf<openvdb::math::AffineMap>();
    }

    template<> VOXELMATEINLINE CONSTEXPR int32 SizeOf<openvdb::math::NonlinearFrustumMap>()
    {
